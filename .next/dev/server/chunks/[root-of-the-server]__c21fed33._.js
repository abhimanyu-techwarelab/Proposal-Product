...
"[project]/src/lib/jwt-auth.ts [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$jwt$2d$auth$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/jwt-auth.ts [middleware] (ecmascript)");
;
;
function proxy(request) {
    ...
    const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$jwt$2d$auth$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["getTokenFromCookies"])(cookies);
    const isValid = token ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$jwt$2d$auth$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["isTokenValid"])(token) : false;
    ...
    if (!token || !isValid) {
        ...
        if (pathname !== "/login") {
            ...
            const safeRedirect = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$jwt$2d$auth$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["validateRedirectUrl"])(pathname, "/dashboard");
    ...
    if (token && isValid) {
        const payload = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$jwt$2d$auth$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["decodeJWT"])(token);
        ...
        if (hasAdminAccess) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(unauthorizedUrl);
        }
        // Role-based access control for /proposals routes
        if (pathname.startsWith("/proposals")) {
            // Check if user has read_proposals_product permission
            const hasProposalAccess = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$jwt$2d$auth$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["hasPermission"])(token, "read_proposals_product");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c21fed33._.js.map
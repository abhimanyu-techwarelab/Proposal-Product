...
"[project]/src/lib/api/permissions.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/(dashboard)/roles/[id]/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$permissions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/api/permissions.ts [app-ssr] (ecmascript)");
...
function EditRolePage() {
    ...
    const [initialName, setInitialName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("");
    const [initialDescription, setInitialDescription] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("");
    // Permissions state
    ...
    const [selectedPermissions, setSelectedPermissions] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(new Set());
    const [initialPermissions, setInitialPermissions] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(new Set());
    ...
    const groupedPermissions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        async function fetchData() {
            try {
                ...
                const [roleResult, permissionsResult, allPermissionsResult] = await Promise.all([
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$roles$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["rolesApi"].getById(roleId),
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$permissions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["permissionsApi"].list(),
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$permissions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["permissionsApi"].listAll()
                ]);
                ...
                if (permissionsResult.success && permissionsResult.data) {
                    ...
                    console.log("Product permission IDs:", permissionsResult.data.map((p)=>p.id));
                    console.log("Product permission keys:", permissionsResult.data.map((p)=>p.key));
                    setPermissions(permissionsResult.data);
                } else {
                    console.error("Failed to fetch permissions:", permissionsResult);
                }
                // Fetch role permissions (same as admin panel)
                const rolePermissionsResult = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$permissions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["permissionsApi"].getRolePermissions(roleId);
                ...
                if (rolePermissionsResult.success && rolePermissionsResult.data) {
                    ...
                    const activeRolePermissions = rolePermissionsResult.data.filter((rp)=>rp.is_active);
                    console.log("Active role permissions:", activeRolePermissions);
                    const activePermissionIds = new Set(activeRolePermissions.map((rp)=>rp.permission_id));
                    ...
                    if (permissionsResult.success && permissionsResult.data && allPermissionsResult.success && allPermissionsResult.data) {
                        ...
                        activeRolePermissions.forEach((rp)=>{
    ...
    const hasChanges = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        const permissionsChanged = selectedPermissions.size !== initialPermissions.size || Array.from(selectedPermissions).some((id)=>!initialPermissions.has(id)) || Array.from(initialPermissions).some((id)=>!selectedPermissions.has(id));
    ...
    const handleUpdateRole = async ()=>{
        ...
        try {
            ...
            const roleResult = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$roles$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["rolesApi"].update(roleId, updateDto);
            ...
            try {
                const permResult = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$permissions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["permissionsApi"].updateRolePermissions(permissionAssignments);
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "space-y-4",
                                    children: Object.entries(groupedPermissions).map(([groupName, groupPerms])=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                expandedGroups.has(groupName) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        canUpdateRoles && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=_d69e8f7f._.js.map
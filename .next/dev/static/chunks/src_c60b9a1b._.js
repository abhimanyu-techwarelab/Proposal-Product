...
"[project]/src/components/ui/glitchy-404.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const FuzzyWrapper = ({ children, baseIntensity = 0.3, className })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FuzzyWrapper.useEffect": ()=>{
            ...
            const init = {
                "FuzzyWrapper.useEffect.init": async ()=>{
                    ...
                    await new Promise({
                        "FuzzyWrapper.useEffect.init": (resolve)=>setTimeout(resolve, 100)
                    }["FuzzyWrapper.useEffect.init"]);
                    // Get SVG dimensions
                    ...
                    const convertSvgToCanvas = {
                        "FuzzyWrapper.useEffect.init.convertSvgToCanvas": ()=>{
                            return new Promise({
                                "FuzzyWrapper.useEffect.init.convertSvgToCanvas": (resolve)=>{
                    ...
                    const fuzzRange = 20;
                    const run = {
                        "FuzzyWrapper.useEffect.init.run": async ()=>{
                            if (isCancelled) return;
                    ...
                    }["FuzzyWrapper.useEffect.init.run"];
                    run();
                    const cleanup = {
                        "FuzzyWrapper.useEffect.init.cleanup": ()=>{
...
_s(FuzzyWrapper, "z0UG+eSsmR1vz8ZPQFfuSeF9PAY=");
_c = FuzzyWrapper;
function Glitchy404({ width = 860, height = 232, color = "#fff", onRepair, enableRepairMode = false }) {
    ...
    const [repairProgress, setRepairProgress] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [isRepaired, setIsRepaired] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const handleMouseEnter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Glitchy404.useCallback[handleMouseEnter]": ()=>{
            ...
            progressIntervalRef.current = setInterval({
                "Glitchy404.useCallback[handleMouseEnter]": ()=>{
                    setRepairProgress({
                        "Glitchy404.useCallback[handleMouseEnter]": (prev)=>{
                            if (prev >= 100) {
            ...
            }["Glitchy404.useCallback[handleMouseEnter]"], 30);
            ...
            }["Glitchy404.useCallback[handleMouseEnter]"], 1500);
        }
    }["Glitchy404.useCallback[handleMouseEnter]"], [
        enableRepairMode,
        isRepaired,
    ...
    const handleMouseLeave = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Glitchy404.useCallback[handleMouseLeave]": ()=>{
            if (!enableRepairMode || isRepaired) return;
            setIsHovered(false);
            // Clear timers
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(FuzzyWrapper, {
...
_s1(Glitchy404, "NnF1kPSnCk1S5AWUZzHEOMRh+Qg=");
_c1 = Glitchy404;
var _c, _c1;
__turbopack_context__.k.register(_c, "FuzzyWrapper");
__turbopack_context__.k.register(_c1, "Glitchy404");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/components/ui/hidden-terminal.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function HiddenTerminal({ isOpen, onClose }) {
    ...
    const processCommand = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "HiddenTerminal.useCallback[processCommand]": (cmd)=>{
            const trimmedCmd = cmd.trim().toLowerCase();
            // Add input to display
            setLines({
                "HiddenTerminal.useCallback[processCommand]": (prev)=>[
                        ...prev,
                        {
                            type: "input",
                            content: `> ${cmd}`
            ...
            }["HiddenTerminal.useCallback[processCommand]"]);
            // Add to history
            if (trimmedCmd) {
                setCommandHistory({
                    "HiddenTerminal.useCallback[processCommand]": (prev)=>[
            ...
            if (response) {
                ...
                outputLines.forEach({
                    "HiddenTerminal.useCallback[processCommand]": (line, index)=>{
                        setTimeout({
                            "HiddenTerminal.useCallback[processCommand]": ()=>{
                                setLines({
                                    "HiddenTerminal.useCallback[processCommand]": (prev)=>[
                        ...
                        }["HiddenTerminal.useCallback[processCommand]"], index * 50);
                    }
                }["HiddenTerminal.useCallback[processCommand]"]);
            } else if (trimmedCmd) {
                setLines({
...
_s(HiddenTerminal, "5lmNAiA52fQ4YN6HPKLnt4NLiyc=");
_c = HiddenTerminal;
function useKonamiCode(callback) {
    ...
    const [inputSequence, setInputSequence] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
...
_s1(useKonamiCode, "aFKL3TbLj0MxhJLJOzdkziIzIeI=");
function useTripleClick(callback) {
    ...
    const handleClick = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useTripleClick.useCallback[handleClick]": ()=>{
            ...
            if (clickCountRef.current >= 3) {
                ...
                }["useTripleClick.useCallback[handleClick]"], 500);
            }
        }
    }["useTripleClick.useCallback[handleClick]"], [
        callback
...
_s2(useTripleClick, "36L6guIfXIHJds4xd+EU3zkda6o=");
var _c;
__turbopack_context__.k.register(_c, "HiddenTerminal");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$glitchy$2d$404$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ui/glitchy-404.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$hidden$2d$terminal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ui/hidden-terminal.tsx [app-client] (ecmascript)");
;
...
function NotFound() {
    ...
    const [isRepaired, setIsRepaired] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const openTerminal = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "NotFound.useCallback[openTerminal]": ()=>{
            setIsTerminalOpen(true);
        }
    }["NotFound.useCallback[openTerminal]"], []);
    // Konami code Easter egg: ↑ ↑ ↓ ↓ ← → ← → B A
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$hidden$2d$terminal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useKonamiCode"])(openTerminal);
    // Triple-click on 404 to open terminal
    const handleTripleClick = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$hidden$2d$terminal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTripleClick"])(openTerminal);
    const handleRepair = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "NotFound.useCallback[handleRepair]": ()=>{
            setIsRepaired(true);
        }
    }["NotFound.useCallback[handleRepair]"], []);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$glitchy$2d$404$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Glitchy404"], {
                            width: 600,
                            height: 174,
                            color: "#B87333",
                    ...
                    isRepaired && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$hidden$2d$terminal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["HiddenTerminal"], {
...
_s(NotFound, "FMgaN2GW09XX1qq+ftVRIKE1VjY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$hidden$2d$terminal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useKonamiCode"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$hidden$2d$terminal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTripleClick"]
    ];
});
_c = NotFound;
var _c;
...
//# sourceMappingURL=src_c60b9a1b._.js.map
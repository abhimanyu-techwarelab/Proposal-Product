...
const SVG404 = ({ width, height, color }: { width: number; height: number; color: string }) => (
  <svg
    width={width}
    height={height}
    viewBox="0 0 100 29"
...
export function Glitchy404({ width = 860, height = 232, color = "#B87333" }: Glitchy404Props) {
  return (
    <>
      ...
      >
        ...
        <div className="glitch-base">
          <SVG404 width={width} height={height} color={color} />
        </div>

        {/* Glitch slice layers */}
        <div className="glitch-slice-1">
          <SVG404 width={width} height={height} color={color} />
        </div>
        <div className="glitch-slice-2">
          <SVG404 width={width} height={height} color={color} />
        </div>
      </div>
    </>
